...
material_result(_Name, Mat0, Res) ->
    %% Rip out all thebounty material properties
...
%%    Ps = [{enabled,Enabled},
%%          {mode,Mode},
%%          {alpha_intensity,AlphaIntensity},
...
%%          {cell_size,CellSize},
%%          {intensity,Intensity},
%%          {cell_weight1,CellWeight1},
%%          {cell_weight2,CellWeight2},
%%          {cell_weight3,CellWeight3},
%%          {cell_weight4,CellWeight4},
%%          {musgrave_type,MusgraveType},
%%          {musgrave_noisesize,MusgraveNoiseSize},
%%          {musgrave_intensity,MusgraveIntensity},
%%          {musgrave_contrast,MusgraveContrast},
%%          {musgrave_lacunarity,MusgraveLacunarity},
%%          {musgrave_octaves,MusgraveOctaves},
                ...
                {vframe, [
                    ...
                    {hframe,[
                        ...
                        {hframe,[
                            ...
                            {text,SunRealPower,[key(sun_real_power),range(sun_real_power)]}
